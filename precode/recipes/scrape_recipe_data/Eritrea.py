...
# #### https://www.196flavors.com/category/continent/africa/north-africa/eritrea/
...
htmlOnePageSpider("https://www.196flavors.com/category/continent/africa/north-africa/eritrea/", htmlLst)
...
for i in range(2,3):
    htmlOnePageSpider("https://www.196flavors.com/category/continent/africa/north-africa/eritrea/page/{}/".format(i), htmlLst)
...
for html in htmlLst:
    try:
        fillEritreaData(html,Eritreadata)
    except:
        time.sleep(5)

# convert data to dataframe
Eritrea = pd.DataFrame(Eritreadata)
print(Eritrea.shape)
Eritrea.head()
...
Eritrea["Source"] = ["Web1" for i in range(len(Eritrea))]
Eritrea.head()
...
# save dataset
Eritrea.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Eritrea.csv")
