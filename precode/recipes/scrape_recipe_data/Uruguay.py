...
def htmlOnePageSpider(category_url, dic):
    ...
    headers = {
        ...
        'cookie': 'recipes_uru=11596544c6e2f27eaeb6eb6883941dcd; _ga=amp-UizWdFdhjN6pqkdqphTwYA',
...
htmlDic = htmlAllPageSpider("https://www.cocina-uruguaya.com/recetas",26)
for key in htmlDic:
    try:
        fillData(key,data)
    except:
...
Uruguay= pd.DataFrame(data)
print(Uruguay.shape)
Uruguay.head()

# save dataset
Uruguay.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Uruguay.csv")
