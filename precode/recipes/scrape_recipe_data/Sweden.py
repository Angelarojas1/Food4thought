...
# #### Scrape all recipes of Sweden

# https://www.chefkoch.de/rs/s0t29,132,133/Europa-Schweden-Skandinavien-Rezepte.html
...
htmlOnePageSpider('https://www.chefkoch.de/rs/s0t29,132,133/Europa-Schweden-Skandinavien-Rezepte.html', htmlLst)
...
def htmlAllPageSpider(htmlLst):
    ...
    for i in range(14):
        pageLst.append('https://www.chefkoch.de/rs/s{}t29,132,133/Europa-Schweden-Skandinavien-Rezepte.html'.format(i))
...
for html in htmlLst:
    try:
        fillSwedenData(html,Swedendata)
    except:
        time.sleep(5)
...
Sweden = pd.DataFrame(Swedendata)
print(Sweden.shape)
Sweden.head()

# save dataset
Sweden.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Sweden.csv")
