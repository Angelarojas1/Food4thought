...
# #### Scrape all recipes of El Salvador
# 
...
def htmlOnePageSpider(category_url, dic):
    ...
    headers = {
        ...
        'cookie': 'recipes_sal=616b77500c47bd7c1a8f3771dbcdc609; _ga=amp-sdAWjBlrZ5qX28i5xV-ebQ',
...
htmlDic = htmlAllPageSpider("https://www.recetassalvador.com/recetas",25)
for key in htmlDic:
    try:
        fillData(key,data)
    except:
...
Salvador = pd.DataFrame(data)
print(Salvador.shape)
Salvador.head()

# save dataset
Salvador.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/EISalvador.csv")
