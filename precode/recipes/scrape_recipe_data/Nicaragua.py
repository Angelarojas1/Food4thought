...
# #### Scrape all recipes of Nicaragua
# 
...
def htmlOnePageSpider(category_url, dic):
    ...
    headers = {
        ...
        'cookie': 'recipes_nic=bd932dfc7d28a886b2ce40e3cd7837dd; _ga=amp-vVHDxohn_PGqo6d08XigZg',
...
htmlDic = htmlAllPageSpider("https://www.recetas-nicaragua.com/recetas",25)
for key in htmlDic:
    try:
        fillData(key,data)
    except:
...
Nicaragua = pd.DataFrame(data)
print(Nicaragua.shape)
Nicaragua.head()

# save dataset
Nicaragua.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Nicaragua.csv")
