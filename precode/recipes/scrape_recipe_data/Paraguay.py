...
# #### Scrape all recipes of Paraguay
# 
...
def htmlOnePageSpider(category_url, dic):
    ...
    headers = {
        ...
        'cookie': 'recipes_par=80f7f138ec49b185716867ba3a1dad7a; _ga=amp-NnTSgmLjAArnuwuGHPQa4A',
...
htmlDic = htmlAllPageSpider("https://www.recetasparaguay.com/recetas",19)
for key in htmlDic:
    try:
        fillData(key,data)
    except:
...
Paraguay = pd.DataFrame(data)
print(Paraguay.shape)
Paraguay.head()

# save dataset
Paraguay.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Paraguay.csv")
