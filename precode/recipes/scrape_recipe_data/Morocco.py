...
htmlOnePageSpider("https://www.bbcgoodfood.com/search/recipes/?q=Moroccan+recipes&sort=-relevance", htmlLst)
...
for i in range(2,8):
    htmlOnePageSpider("https://www.bbcgoodfood.com/search/recipes/page/{}/?q=Moroccan+recipes&sort=-relevance".format(i), htmlLst)
...
for html in htmlLst:
    try:
        fillMoroccoData(html,Moroccodata)
    except:
        time.sleep(5)

# convert data to dataframe
Morocco = pd.DataFrame(Moroccodata)
print(Morocco.shape)
Morocco.head()
...
Morocco["Source"] = ["Web1" for i in range(len(Morocco))]
Morocco.head()
...
# save dataset
Morocco.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Morocco.csv")
