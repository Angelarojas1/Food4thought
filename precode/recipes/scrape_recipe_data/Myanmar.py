...
# #### https://www.sbs.com.au/food/cuisine/myanmar
...
htmlOnePageSpider("https://www.sbs.com.au/food/cuisine/myanmar", htmlLst)
htmlOnePageSpider("https://www.sbs.com.au/food/cuisine/myanmar?sort_by=created&page=1", htmlLst)
htmlOnePageSpider("https://www.sbs.com.au/food/cuisine/myanmar?sort_by=created&page=2", htmlLst)
    ...
    for i in range(length):
        try:
            lst.append([sel.xpath('//div[@class="field field-name-field-ingredients field-type-text-long field-label-above cXenseParse"]/ul/li/strong/text()')[i].get(),
                   sel.xpath('//div[@class="field field-name-field-ingredients field-type-text-long field-label-above cXenseParse"]/ul/li/span/text() | //div[@class="field field-name-field-ingredients field-type-text-long field-label-above cXenseParse"]/ul/li/text()')[i].get()])
        except:
            lst.append(['',
                   sel.xpath('//div[@class="field field-name-field-ingredients field-type-text-long field-label-above cXenseParse"]/ul/li/span/text() | //div[@class="field field-name-field-ingredients field-type-text-long field-label-above cXenseParse"]/ul/li/text()')[i].get()])
...
for html in htmlLst:
    try:
        fillMyanmarData(html,Myanmardata)
    except:
        time.sleep(5)

# convert data to dataframe
Myanmar = pd.DataFrame(Myanmardata)
print(Myanmar.shape)
Myanmar.head()
...
Myanmar["Source"] = ["Web1" for i in range(len(Myanmar))]
Myanmar.head()
...
# save dataset
Myanmar.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Myanmar.csv")
