...
# #### Scrape all recipes of Honduras
# 
...
def htmlOnePageSpider(category_url, dic):
    ...
    headers = {
        ...
        'cookie': 'recipes_hon=3057b35fa10a66d2082eff5c172ade65; _ga=amp-MKHuKtelvV7BOkN7xC6MeA',
...
htmlDic = htmlAllPageSpider("https://www.recetashonduras.com/recetas",24)
for key in htmlDic:
    try:
        fillData(key,data)
    except:
...
Honduras = pd.DataFrame(data)
print(Honduras.shape)
Honduras.head()

# save dataset
Honduras.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Honduras.csv")
