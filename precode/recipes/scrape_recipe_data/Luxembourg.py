...
# #### Scrape all recipes of Luxembourg

# https://www.chefkoch.de/rs/s0t29,161/Europa-Luxemburg-Rezepte.html
...
htmlOnePageSpider('https://www.chefkoch.de/rs/s0t29,161/Europa-Luxemburg-Rezepte.html', htmlLst)
...
def htmlAllPageSpider(htmlLst):
    ...
    for i in range(3):
        pageLst.append('https://www.chefkoch.de/rs/s{}t29,161/Europa-Luxemburg-Rezepte.html'.format(i))
...
def LuxembourgSpider(recipe_url):
    """
...
def fillLuxembourgData(html,dic):
    """
...
for html in htmlLst:
    try:
        fillLuxembourgData(html,Luxembourgdata)
    except:
        time.sleep(5)
...
Luxembourg = pd.DataFrame(Luxembourgdata)
print(Luxembourg.shape)
Luxembourg.head()

# save dataset
Luxembourg.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Luxembourg.csv")
