...
# #### Scrape all recipes of Turkey
# 

# https://www.chefkoch.de/rs/s0t103/Tuerkei-Rezepte.html
...
htmlOnePageSpider('https://www.chefkoch.de/rs/s0t103/Tuerkei-Rezepte.html', htmlLst)
...
def htmlAllPageSpider(htmlLst):
    ...
    for i in range(25):
        pageLst.append('https://www.chefkoch.de/rs/s{}t103/Tuerkei-Rezepte.html'.format(i))
...
for html in htmlLst:
    try:
        fillTurkeyData(html,Turkeydata)
    except:
        time.sleep(5)
...
Turkey = pd.DataFrame(Turkeydata)
print(Turkey.shape)
Turkey.head()

# save dataset
Turkey.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Turkey.csv")
