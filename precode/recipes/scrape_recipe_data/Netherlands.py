...
# #### Scrape all recipes of Netherlands

# https://www.chefkoch.de/rs/s0t29,1076/Europa-Niederlande-Rezepte.html
...
htmlOnePageSpider('https://www.chefkoch.de/rs/s0t29,1076/Europa-Niederlande-Rezepte.html', htmlLst)
...
def htmlAllPageSpider(htmlLst):
    ...
    for i in range(7):
        pageLst.append('https://www.chefkoch.de/rs/s{}t29,1076/Europa-Niederlande-Rezepte.html'.format(i))
...
def NetherlandsSpider(recipe_url):
    """
...
def fillNetherlandsData(html,dic):
    """
    ...
    """
    content = NetherlandsSpider(html)
...
for html in htmlLst:
    try:
        fillNetherlandsData(html,Netherlandsdata)
    except:
        time.sleep(5)
...
Netherlands = pd.DataFrame(Netherlandsdata)
print(Netherlands.shape)
Netherlands.head()

# save dataset
Netherlands.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Netherlands.csv")
