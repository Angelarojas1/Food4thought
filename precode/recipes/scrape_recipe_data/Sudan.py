...
# #### https://www.food.com/topic/sudanese
...
htmlOnePageSpider("https://www.food.com/topic/sudanese", htmlLst)
...
for i in range(2,4):
    htmlOnePageSpider("https://www.food.com/topic/sudanese?pn={}".format(i), htmlLst)
...
for html in htmlLst:
    try:
        fillSudanData(html,Sudandata)
    except:
        time.sleep(5)

# convert data to dataframe
Sudan = pd.DataFrame(Sudandata)
print(Sudan.shape)
Sudan.head()
...
Sudan["Source"] = ["Web1" for i in range(len(Sudan))]
Sudan.head()
...
# save dataset
Sudan.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Sudan.csv")
