...
# #### Scrape all recipes of United Kingdom

# https://www.chefkoch.de/rs/s0t29,117/Europa-Grossbritannien-Rezepte.html
...
htmlOnePageSpider('https://www.chefkoch.de/rs/s0t29,117/Europa-Grossbritannien-Rezepte.html', htmlLst)
...
def htmlAllPageSpider(htmlLst):
    ...
    for i in range(25):
        pageLst.append('https://www.chefkoch.de/rs/s{}t29,117/Europa-Grossbritannien-Rezepte.html'.format(i))
...
UK = pd.DataFrame(UKdata)
print(UK.shape)
UK.head()

# save dataset
UK.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/UK.csv")
