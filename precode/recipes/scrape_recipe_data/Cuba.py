...
def htmlOnePageSpider(category_url, dic):
    ...
    headers = {
        ...
        'cookie': 'recipes_cub=9017a0cee5ada8300448a8f76761914d; _ga=amp-lvYlRDySdJLdGHBLL2fzVw',
...
htmlDic = htmlAllPageSpider("https://www.cocina-cubana.com/recetas",32)
for key in htmlDic:
    try:
        fillData(key,data)
    except:
...
Cuba = pd.DataFrame(data)
print(Cuba.shape)
Cuba.head()

# save dataset
Cuba.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Cuba.csv")
