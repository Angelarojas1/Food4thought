...
# #### Scrape all recipes of Côte d'Ivoire
...
# #### https://www.196flavors.com/category/continent/africa/west-africa/cote-divoire/
...
htmlOnePageSpider("https://www.196flavors.com/category/continent/africa/west-africa/cote-divoire/", htmlLst)
...
def CoteDivoireSpider(recipe_url):
    """
...
def fillCoteDivoireData(html,dic):
    """
    ...
    """
    content = CoteDivoireSpider(html)
...
for html in htmlLst:
    try:
        fillCoteDivoireData(html,CoteDivoiredata)
    except:
        time.sleep(5)

# convert data to dataframe
CoteDivoire = pd.DataFrame(CoteDivoiredata)
print(CoteDivoire.shape)
CoteDivoire.head()
...
CoteDivoire["Source"] = ["Web1" for i in range(len(CoteDivoire))]
CoteDivoire.head()
...
# save dataset
CoteDivoire.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/CoteDivoire.csv")
