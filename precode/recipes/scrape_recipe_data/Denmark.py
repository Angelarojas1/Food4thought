...
# #### Scrape all recipes of Denmark

# https://www.chefkoch.de/rs/s0t29,130/Europa-Daenemark-Rezepte.html
...
htmlOnePageSpider('https://www.chefkoch.de/rs/s0t29,130/Europa-Daenemark-Rezepte.html', htmlLst)
...
def htmlAllPageSpider(htmlLst):
    ...
    for i in range(8):
        pageLst.append('https://www.chefkoch.de/rs/s{}t29,130/Europa-Daenemark-Rezepte.html'.format(i))
...
for html in htmlLst:
    try:
        fillDenmarkData(html,Denmarkdata)
    except:
        time.sleep(5)
...
Denmark = pd.DataFrame(Denmarkdata)
print(Denmark.shape)
Denmark.head()

# save dataset
Denmark.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Denmark.csv")
