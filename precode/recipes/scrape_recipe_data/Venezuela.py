...
# #### Scrape all recipes of Venezuela
# 
# 
...
def htmlOnePageSpider(category_url, dic):
    ...
    headers = {
        ...
        'cookie': 'recipes_ven=2c501f2476868819b22c9f6321457526; _ga=amp-k9A8pSrjFecbXHzQnxQX-g',
...
htmlDic = htmlAllPageSpider("https://www.recetas-venezolanas.com/recetas",19)
for key in htmlDic:
    try:
        fillData(key,data)
    except:
...
Venezuela= pd.DataFrame(data)
print(Venezuela.shape)
Venezuela.head()

# save dataset
Venezuela.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Venezuela.csv")
