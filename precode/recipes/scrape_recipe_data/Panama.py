...
def htmlOnePageSpider(category_url, dic):
    ...
    headers = {
        ...
        'cookie': 'recipes_pan=3c221f8bfcf59b5c64ecee86100dde6c; _ga=amp-XJj5DtHng1qUfDoAkYdILg',
...
htmlDic = htmlAllPageSpider("https://www.recetaspanama.com/recetas",26)
for key in htmlDic:
    try:
        fillData(key,data)
    except:
...
Panama = pd.DataFrame(data)
print(Panama.shape)
Panama.head()

# save dataset
Panama.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Panama.csv")
