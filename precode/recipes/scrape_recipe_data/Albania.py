...
custom_header_template = { #setup custom header because this website requires certain headers
        'referer': 'https://www.myalbanianfood.com/',
        'Accept-Language': '*',
        'Accept-Encoding': '*', 
...
albania_spider = Spider('https://www.myalbanianfood.com', seeds, listing,attrs, available_json=available_json, header=custom_header_template)


# In[5]:


albania_spider.scrape_one_item('https://www.myalbanianfood.com/recipe/albanian-kulac-albanian-soda-bread/')


# In[6]:


result_list = albania_spider.start_scrape()
...
result_df.to_csv('data/albania/albania.csv')
