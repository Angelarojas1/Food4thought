...
# #### Scrape all recipes of Belgium

# 1. https://www.chefkoch.de/rs/s0t29,154/Europa-Belgien-Rezepte.html
...
htmlOnePageSpider('https://www.chefkoch.de/rs/s0t29,154/Europa-Belgien-Rezepte.html', htmlLst)
...
def htmlAllPageSpider(htmlLst):
    ...
    for i in range(5):
        pageLst.append('https://www.chefkoch.de/rs/s{}t29,154/Europa-Belgien-Rezepte.html'.format(i))
...
for html in htmlLst:
    try:
        fillBelgiumData(html,Belgiumdata)
    except:
        time.sleep(5)
...
Belgium = pd.DataFrame(Belgiumdata)
print(Belgium.shape)
Belgium.head()

# save dataset
Belgium.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Belgium.csv")
