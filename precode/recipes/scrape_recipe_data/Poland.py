...
# #### Scrape all recipes of Poland

# https://www.chefkoch.de/rs/s0t29,86,125/Europa-Osteuropa-Polen-Rezepte.html
# 
...
htmlOnePageSpider('https://www.chefkoch.de/rs/s0t29,86,125/Europa-Osteuropa-Polen-Rezepte.html', htmlLst)
...
def htmlAllPageSpider(htmlLst):
    ...
    for i in range(12):
        pageLst.append('https://www.chefkoch.de/rs/s{}t29,86,125/Europa-Osteuropa-Polen-Rezepte.html'.format(i))
...
for html in htmlLst:
    try:
        fillPolandData(html,Polanddata)
    except:
        time.sleep(5)
...
Poland = pd.DataFrame(Polanddata)
print(Poland.shape)
Poland.head()

# save dataset
Poland.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Poland.csv")
