...
# #### Scrape all recipes of Guatemala
# 
...
def htmlOnePageSpider(category_url, dic):
    ...
    headers = {
        ...
        'cookie': 'recipes_gua=f3bc61ea628b93bf99f68668263c559e; _ga=amp-fUiPmOjYWIPtexpy8xiuAA',
...
htmlDic = htmlAllPageSpider("https://www.recetas-guatemala.com/recetas",31)
for key in htmlDic:
    try:
        fillData(key,data)
    except:
...
Guatemala = pd.DataFrame(data)
print(Guatemala.shape)
Guatemala.head()

# save dataset
Guatemala.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Guatemala.csv")
