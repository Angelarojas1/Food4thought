...
# #### Scrape all recipes of Norway

# https://www.chefkoch.de/rs/s0t29,133,160/Europa-Skandinavien-Norwegen-Rezepte.html
...
htmlOnePageSpider('https://www.chefkoch.de/rs/s0t29,133,160/Europa-Skandinavien-Norwegen-Rezepte.html', htmlLst)
...
def htmlAllPageSpider(htmlLst):
    ...
    for i in range(4):
        pageLst.append('https://www.chefkoch.de/rs/s{}t29,133,160/Europa-Skandinavien-Norwegen-Rezepte.html'.format(i))
...
for html in htmlLst:
    try:
        fillNorwayData(html,Norwaydata)
    except:
        time.sleep(5)
...
Norway = pd.DataFrame(Norwaydata)
print(Norway.shape)
Norway.head()

# save dataset
Norway.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Norway.csv")
