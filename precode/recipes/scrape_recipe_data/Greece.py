...
# #### Scrape all recipes of Greece

# https://www.chefkoch.de/rs/s0t29,44/Europa-Griechenland-Rezepte.html
# 
...
def htmlAllPageSpider(htmlLst):
    ...
    for i in range(25):
        pageLst.append('https://www.chefkoch.de/rs/s{}t29,44/Europa-Griechenland-Rezepte.html'.format(i))
...
for html in htmlLst:
    try:
        fillGreeceData(html,Greecedata)
    except:
        time.sleep(5)
...
Greece = pd.DataFrame(Greecedata)
print(Greece.shape)
Greece.head()

# save dataset
Greece.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Greece.csv")
