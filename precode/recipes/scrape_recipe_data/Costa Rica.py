...
# #### Scrape all recipes of Costa Rica
# 
...
def htmlOnePageSpider(category_url, dic):
    ...
    headers = {
        ...
        'cookie': 'recipes_cos=e893275fc1e0fd08f35dfd61a52f0532; _ga=amp-lxx1Wcok0q6c5RAQZy0dQQ',
...
def fillCostaData(key,dic):
    """
    input: key, the key in html dic
    output: fill in data
    
    """
    content = Costaspider(htmlDic[key])
...
htmlDic = htmlAllPageSpider("https://www.recetascostarica.com/recetas",31)
for key in htmlDic:
    try:
        fillCostaData(key,Costadata)
    except:
        time.sleep(5)
...
Costa = pd.DataFrame(Costadata)
print(Costa.shape)
Costa.head()

# save dataset
Costa.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/CostaRica.csv")
