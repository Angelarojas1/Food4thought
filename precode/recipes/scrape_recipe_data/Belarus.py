...
# https://www.chefkoch.de/rs/s0t86,96/Osteuropa-Weissrussland-Rezepte.html
...
htmlOnePageSpider('https://www.chefkoch.de/rs/s0t86,96/Osteuropa-Weissrussland-Rezepte.html', htmlLst)
...
def htmlAllPageSpider(htmlLst):
    ...
    for i in range(2):
        pageLst.append('https://www.chefkoch.de/rs/s{}t86,96/Osteuropa-Weissrussland-Rezepte.html'.format(i))
...
for html in htmlLst:
    try:
        fillBelarusData(html,Belarusdata)
    except:
        time.sleep(5)
...
Belarus = pd.DataFrame(Belarusdata)
print(Belarus.shape)
Belarus.head()

# save dataset
Belarus.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Belarus.csv")
