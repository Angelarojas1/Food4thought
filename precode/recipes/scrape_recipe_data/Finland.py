...
# #### Scrape all recipes of Finland

# https://www.chefkoch.de/rs/s0t29,158/Europa-Finnland-Rezepte.html
...
htmlOnePageSpider('https://www.chefkoch.de/rs/s0t29,158/Europa-Finnland-Rezepte.html', htmlLst)
...
def htmlAllPageSpider(htmlLst):
    ...
    for i in range(6):
        pageLst.append('https://www.chefkoch.de/rs/s{}t29,158/Europa-Finnland-Rezepte.html'.format(i))
...
for html in htmlLst:
    try:
        fillFinlandData(html,Finlanddata)
    except:
        time.sleep(5)
...
Finland = pd.DataFrame(Finlanddata)
print(Finland.shape)
Finland.head()

# save dataset
Finland.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Finland.csv")
