...
def htmlOnePageSpider(category_url, dic):
    ...
    headers = {
        ...
        'cookie': 'recipes_ecu=0395519f1d4e32cb2259c8e95c191848; _ga=amp-VB88BVxxA86JrwZfznlG0w',
...
htmlDic = htmlAllPageSpider("https://www.cocina-ecuatoriana.com/recetas",36)
for key in htmlDic:
    try:
        fillData(key,data)
    except:
...
Ecuador = pd.DataFrame(data)
print(Ecuador.shape)
Ecuador.head()

# save dataset
Ecuador.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Ecuador.csv")
