...
# #### Scrape all recipes of Portugal

# https://www.chefkoch.de/rs/s0t29,149/Europa-Portugal-Rezepte.html
...
htmlOnePageSpider('https://www.chefkoch.de/rs/s0t29,149/Europa-Portugal-Rezepte.html', htmlLst)
...
def htmlAllPageSpider(htmlLst):
    ...
    for i in range(23):
        pageLst.append('https://www.chefkoch.de/rs/s{}t29,149/Europa-Portugal-Rezepte.html'.format(i))
...
for html in htmlLst:
    try:
        fillPortugalData(html,Portugaldata)
    except:
        time.sleep(5)
...
Portugal = pd.DataFrame(Portugaldata)
print(Portugal.shape)
Portugal.head()

# save dataset
Portugal.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Portugal.csv")
