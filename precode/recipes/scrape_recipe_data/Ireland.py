...
# #### https://www.bbcgoodfood.com/search?q=Irish+recipes
...
htmlOnePageSpider("https://www.bbcgoodfood.com/search?q=Irish+recipes", htmlLst)
...
for i in range(2,4):
    htmlOnePageSpider("https://www.bbcgoodfood.com/search/recipes/page/{}/?q=Irish+recipes&sort=-relevance".format(i), htmlLst)
...
for html in htmlLst:
    try:
        fillIrelandData(html,Irelanddata)
    except:
        time.sleep(5)

# convert data to dataframe
Ireland = pd.DataFrame(Irelanddata)
print(Ireland.shape)
Ireland.head()
...
Ireland["Source"] = ["Web1" for i in range(len(Ireland))]
Ireland.head()
...
# save dataset
Ireland.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Ireland.csv")
