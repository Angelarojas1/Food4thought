...
# #### Scrape all recipes of United States of America
...
# #### https://www.bbcgoodfood.com/search?q=American+recipes
...
htmlOnePageSpider("https://www.bbcgoodfood.com/search?q=American+recipes", htmlLst)
...
for i in range(2,9):
    htmlOnePageSpider("https://www.bbcgoodfood.com/search/recipes/page/{}/?q=American+recipes&sort=-relevance".format(i), htmlLst)
...
US["Source"] = ["Web1" for i in range(len(US))]
US.head()
...
# save dataset
US.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/US.csv")
