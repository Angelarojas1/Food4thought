...
# #### Scrape all recipes of Czech Republic

# https://www.chefkoch.de/rs/s0t29,86,97/Europa-Osteuropa-Tschechien-Rezepte.html
...
htmlOnePageSpider('https://www.chefkoch.de/rs/s0t29,86,97/Europa-Osteuropa-Tschechien-Rezepte.html', htmlLst)
...
def htmlAllPageSpider(htmlLst):
    ...
    for i in range(6):
        pageLst.append('https://www.chefkoch.de/rs/s{}t29,86,97/Europa-Osteuropa-Tschechien-Rezepte.html'.format(i))
...
Czech = pd.DataFrame(Czechdata)
print(Czech.shape)
Czech.head()

# save dataset
Czech.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Czech.csv")
