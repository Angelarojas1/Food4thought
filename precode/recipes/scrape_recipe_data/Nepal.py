...
# #### https://www.food.com/topic/nepalese
...
htmlOnePageSpider("https://www.food.com/topic/nepalese", htmlLst)
...
for i in range(2,13):
    htmlOnePageSpider("https://www.food.com/topic/nepalese?pn={}".format(i), htmlLst)
...
for html in htmlLst:
    try:
        fillNepalData(html,Nepaldata)
    except:
        time.sleep(5)

# convert data to dataframe
Nepal = pd.DataFrame(Nepaldata)
print(Nepal.shape)
Nepal.head()
...
Nepal["Source"] = ["Web1" for i in range(len(Nepal))]
Nepal.head()
...
# save dataset
Nepal.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Nepal.csv")
