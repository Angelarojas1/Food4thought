...
# #### Scrape all recipes of France

# https://www.chefkoch.de/rs/s0t29,84/Europa-Frankreich-Rezepte.html
...
htmlOnePageSpider('https://www.chefkoch.de/rs/s0t29,84/Europa-Frankreich-Rezepte.html', htmlLst)
...
def htmlAllPageSpider(htmlLst):
    ...
    for i in range(25):
        pageLst.append('https://www.chefkoch.de/rs/s{}t29,84/Europa-Frankreich-Rezepte.html'.format(i))
...
for html in htmlLst:
    try:
        fillFranceData(html,Francedata)
    except:
        time.sleep(5)
...
France = pd.DataFrame(Francedata)
print(France.shape)
France.head()

# save dataset
France.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/France.csv")
