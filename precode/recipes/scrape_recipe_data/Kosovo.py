...
# #### https://balkanlunchbox.com/category/country/kosovo-recipes/
...
def htmlOnePageSpider(category_url, lst):
    ...
    headers = {
        ...
        'cookie':'_ga=GA1.2.1097360616.1650375630; dgd_scrollbox-4433=0; _gid=GA1.2.1219545651.1652111345; _gat=1',
...
htmlOnePageSpider("https://balkanlunchbox.com/category/country/kosovo-recipes/", htmlLst)
...
for i in range(2,5):
    htmlOnePageSpider("https://balkanlunchbox.com/category/country/kosovo-recipes/page/{}/".format(i), htmlLst)
...
for html in htmlLst:
    try:
        fillKosovoData(html,Kosovodata)
    except:
        time.sleep(5)

# convert data to dataframe
Kosovo = pd.DataFrame(Kosovodata)
print(Kosovo.shape)
Kosovo.head()
...
Kosovo["Source"] = ["Web1" for i in range(len(Kosovo))]
Kosovo.head()
...
# save dataset
Kosovo.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Kosovo.csv")
