...
def htmlOnePageSpider(category_url, dic):
    ...
    headers = {
        ...
        'cookie': 'recipes_bol=31f0c6ae7c43784e63d0dc4d6eaac708; _ga=amp-KK-_UD446I-uKALco9qsPA',
...
def fillBoliviaData(key,dic):
    """
    input: key, the key in html dic
    output: fill in data
    
    """
    content = Boliviaspider(htmlDic[key])
...
htmlDic = htmlAllPageSpider("https://www.cocina-boliviana.com/recetas",44)
for key in htmlDic:
    try:
        fillBoliviaData(key,Boliviadata)
    except:
        time.sleep(5)
...
Bolivia = pd.DataFrame(Boliviadata)
print(Bolivia.shape)
Bolivia.head()

# save dataset
Bolivia.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Bolivia.csv")
