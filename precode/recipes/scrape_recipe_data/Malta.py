...
# #### Scrape all recipes of Malta

# https://www.chefkoch.de/rs/s0t29,167/Europa-Malta-Rezepte.html
...
htmlOnePageSpider('https://www.chefkoch.de/rs/s0t29,167/Europa-Malta-Rezepte.html', htmlLst)
...
Malta = pd.DataFrame(Maltadata)
print(Malta.shape)
Malta.head()

# save dataset
Malta.to_csv("/Users/xixi/Dropbox/food4thought/data/raw/Malta.csv")
