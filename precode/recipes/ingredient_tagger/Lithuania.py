...
# ```
# 
# #### Ingredient Tagger of Lithuania
# 
# 
# 
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Lithuania.csv")
data.shape
...
data['List of ingredients_Eng'].head(10)[5]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Lithuania.csv")
