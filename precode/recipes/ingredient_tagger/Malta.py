...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Malta.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Malta.csv")
