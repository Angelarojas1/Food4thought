...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Samoa.csv")
data.shape
...
data['List of ingredients'].head(30)[1]
...
data['List of ingredients'].head()[4]
...
data['List of ingredients'].head()[3]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Samoa.csv")
