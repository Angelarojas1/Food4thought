...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Sudan.csv")
data.shape
...
data['List of ingredients'].head(10)[9]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Sudan.csv")
