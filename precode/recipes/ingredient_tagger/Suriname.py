...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Suriname.csv")
print(data.shape)
...
data['List of ingredients'] = data['List of ingredients'].apply(lambda x: cleanhtml(x))
data['List of ingredients'] = data['List of ingredients'].apply(lambda x: re.sub(r"[\[\]]",'',x))
data['List of ingredients'] = data['List of ingredients'].apply(lambda x: x.replace("'","").replace("#","").replace("-","to").replace("*","").replace('? ? ','').replace('?','').replace('•',''))
data['List of ingredients'] = data['List of ingredients'].apply(lambda x: x.replace("½",'0.5').replace('¼','0.25').replace('⅓','0.3333'))
data['List of ingredients'] = data['List of ingredients'].apply(lambda x: ' '.join(x.split()))
data['List of ingredients'] = data['List of ingredients'].apply(lambda x: x.replace('1 1/2','1.5').replace('1/2','0.5').replace('1 1/4','1.25').replace('1 1/3','1.3333').replace('1 0.5','1.5').replace('1 0.25','1.25').replace('1,500','1500').replace('1 500','1500').replace('2 0.5','2.5').replace('2 0.25','2.25').replace('3 0.5','3.5').replace('4 0.5','4.5').replace('7 0.5','7.5'))
data['List of ingredients'] = data['List of ingredients'].apply(lambda x: x.replace('1/2','0.5').replace('1/4','0.25').replace('3/4','0.75').replace('1/3','0.3333').replace('2/3','0.6667').replace('1/8','0.125').replace('2 1','2-1').replace('4/5','0.8').replace('5/6','8.3333').replace('100/150','100 to 150'))
data['List of ingredients'] = data['List of ingredients'].apply(lambda x: x.replace("//"," ") ) 
data['List of ingredients'] = data['List of ingredients'].apply(lambda x: x.replace("/"," ") ) 
data['List of ingredients'] = data['List of ingredients'].apply(lambda x: re.split('\s+(?=\d)', x))
...
data['List of ingredients'].head(2000)[26]


# In[ ]:


data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Suriname_trial.csv")


# In[ ]:


data['List of ingredients'].head(2000)[1066]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Suriname_Eng.csv")


# In[ ]:


data['List of ingredients'].tail()
...
def ingredientLstTagger(ingredientStr):
...
data['Ingredient list tagger'].head(10)[9]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Suriname.csv")
