...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Estonia.csv")
data.shape
...
data['Ingredient list tagger'].head(20)[6]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Estonia.csv")
