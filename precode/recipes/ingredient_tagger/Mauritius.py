...
# #### Ingredient Tagger of Mauritius
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Mauritius.csv")
data.shape
...
data['List of ingredients'].head(20)[19]
...
data['Ingredient list tagger'].head(38)[35]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Mauritius.csv")
