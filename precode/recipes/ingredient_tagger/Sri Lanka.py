...
# #### Ingredient Tagger of Sri Lanka
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Sri Lanka.csv")
data.shape
...
data['Ingredient list tagger'].head(30)[5]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Sri Lanka.csv")
