...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Tonga.csv")
data.shape
...
data['Ingredient list tagger'].head(10)[1]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Tonga.csv")
