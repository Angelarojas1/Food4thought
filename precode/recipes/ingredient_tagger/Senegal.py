...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Senegal.csv")
data.shape
...
data['Ingredient list tagger'].head(10)[8]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Senegal.csv")
