...
# #### Ingredient Tagger of Cabo Verde
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Cabo Verde.csv")
data.shape
...
data['Ingredient list tagger'].tail(30)[465]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Cabo Verde.csv")
