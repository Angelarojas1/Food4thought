...
# ```
# 
# #### Ingredient Tagger of Australia
# 
# 
# 
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Australia.csv")
data.shape
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Australia.csv")
