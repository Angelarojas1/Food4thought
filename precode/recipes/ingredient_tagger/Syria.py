...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/raw/Syria.csv")
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Syria.csv")
