...
# ```
# 
# #### Ingredient Tagger of Kyrgyztan
# 
# > Indented block
# 
# 
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Kyrgyzstan.csv")
data.shape
...
data['List of ingredients_Eng'].head()[1]
...
data['Ingredient list tagger'].head(20)[9] 
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Kyrgyztan.csv")
