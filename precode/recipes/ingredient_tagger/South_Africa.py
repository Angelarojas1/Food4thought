...
# #### Ingredient Tagger of South Africa
# 
# 
# 
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/South Africa.csv")
data.shape
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Pakistan.csv")
