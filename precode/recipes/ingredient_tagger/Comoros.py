...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Comoros.csv")
data.shape
...
data['List of ingredients'].tail()[97]
...
data['List of ingredients_Eng'].head(30)[27]
...
data['Ingredient list tagger'].head(30)[9]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Comoros.csv")
