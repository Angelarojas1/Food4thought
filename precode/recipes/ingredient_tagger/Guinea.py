...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Guinea.csv")
data.shape
...
data['List of ingredients'].tail()[19]
...
data['List of ingredients_Eng'].head(20)[19]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Guinea.csv")
