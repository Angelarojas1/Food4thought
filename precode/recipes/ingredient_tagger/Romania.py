...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Romania.csv")
data.shape
...
def ingredientTagger(ingredientStr):
    ...
    ingredientStr = ingredientStr.lower().split(' or ')[0]
...
data['Ingredient list tagger'].head(100)[91]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Romania.csv")
