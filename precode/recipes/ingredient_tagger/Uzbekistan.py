...
# #### Ingredient Tagger of Uzbekistan
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Uzbekistan.csv")
data.shape
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Uzbekistan.csv")
