...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Spain.csv")
data.shape
...
data['List of ingredients_Eng'].head()[3]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Spain.csv")
