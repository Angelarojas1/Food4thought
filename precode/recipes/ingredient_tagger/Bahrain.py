...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Bahrain.csv") 
data.shape
...
data['List of ingredients'].head(30)[10]
...
data['List of ingredients_Eng'].head()[0]
...
data['Ingredient list tagger'].head(20)[0]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Bahrain.csv")
