...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Armenia.csv")
data.shape
...
len(data['List of ingredients'][0])
...
data['Ingredient list tagger'].tail(20)[931]
...
#data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Armenia.csv")
