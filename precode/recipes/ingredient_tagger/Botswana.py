...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Botswana.csv")
data.shape
...
data['List of ingredients'][2]


# In[16]:


data['List of ingredients'][21]
...
data['Ingredient list tagger'].head(20)[15]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Botswana.csv")
