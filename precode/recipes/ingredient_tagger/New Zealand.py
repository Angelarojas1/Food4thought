...
# #### Ingredient Tagger of New Zealand
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/New Zealand.csv")
data.shape
...
data['Ingredient list tagger'].head(30)[3]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/New Zealand.csv")
