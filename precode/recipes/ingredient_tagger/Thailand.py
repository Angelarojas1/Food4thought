...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Thailand.csv")
data.shape
...
data['List of ingredients'].head()[2]
...
data['Ingredient list tagger'].head(10)[0]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Thailand.csv")
