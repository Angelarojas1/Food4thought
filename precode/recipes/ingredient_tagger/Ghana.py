...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Ghana.csv")
data.shape
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Ghana.csv")
