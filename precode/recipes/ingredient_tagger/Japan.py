...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Japan.csv")
data.shape
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Japan_Eng.csv")
data.head()
...
data['List of ingredients_Eng'].head(40)[11]
...
data['Ingredient list tagger'].head(2000)[154]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Japan.csv")
