...
# #### Ingredient Tagger of Cote Divoire
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Cote Divoire.csv")
data.shape
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Cote Divoire.csv")
