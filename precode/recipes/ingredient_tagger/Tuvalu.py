...
# #### Ingredient Tagger of Tuvalu

# In[1]:


# import packages
get_ipython().system('pip install deep_translator==1.8.3')
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Tuvalu.csv")
data.shape
...
data['List of ingredients'].head()[0]
...
data['List of ingredients'] = data['List of ingredients'].apply(lambda x: x.replace("1 0.5",'1.5').replace('1 0.25','5.25').replace('1 0.3333','1.3333'))
...
data['List of ingredients'].head(50)[19]
...
data['Ingredient list tagger'].head(10)[7]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Tuvalu.csv")
