...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Vanuatu.csv")
data.shape
...
data['Ingredient list tagger'].tail()[42]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Vanuatu.csv")
