...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Mongolia.csv")
data.shape
...
data['List of ingredients'].tail(50)[16]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Mongolia.csv")
