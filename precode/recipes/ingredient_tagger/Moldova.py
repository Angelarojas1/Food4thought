...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Moldova.csv")
data.shape
...
data['List of ingredients_Eng'].head(40)[39]
...
data['Ingredient list tagger'].head(30)[15]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Moldova.csv")
