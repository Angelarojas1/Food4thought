...
# #### Ingredient Tagger of Philippines
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Philippines.csv")
data.shape
...
data['List of ingredients'].head(30)[5]
...
data['List of ingredients'].tail(2000)[1223]
...
data['Ingredient list tagger'].head(100)[15]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Philippines.csv")
