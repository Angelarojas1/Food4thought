...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Latvia.csv")
data.shape
...
data['Ingredient list tagger'].head(20)[11]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Latvia.csv")
