...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Nepal.csv")
data.shape
...
data['Ingredient list tagger'].head(30)[4]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Nepal.csv")
