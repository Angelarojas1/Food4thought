...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/raw/Kuwait.csv")
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Kuwait.csv")
