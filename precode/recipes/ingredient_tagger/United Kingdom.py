...
# #### Ingredient Tagger of United Kingdom
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/United Kingdom.csv")
data.shape
...
data['Ingredient list tagger'].head(100)[99]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/United Kingdom.csv")
