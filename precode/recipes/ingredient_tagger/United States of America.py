...
# #### Ingredient Tagger of United States of America
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/United States.csv")
data.shape
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/United States.csv")
