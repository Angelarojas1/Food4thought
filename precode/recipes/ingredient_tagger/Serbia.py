...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Serbia.csv")
data.shape
...
data['List of ingredients'].head(20)[15]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Serbia.csv")
