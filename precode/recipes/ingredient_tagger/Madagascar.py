...
# #### Ingredient Tagger of Madagascar
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Madagascar.csv")
data.shape
...
data['List of ingredients_Eng'].head(10)[8]
...
data['Ingredient list tagger'].tail(30)[22]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Madagascar.csv")
