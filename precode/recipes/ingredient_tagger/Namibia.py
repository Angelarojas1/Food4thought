...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Namibia.csv")
data.shape
...
data['List of ingredients_Eng'].head(20)[3]
...
def ingredientTagger(ingredientStr):
    ...
    result["input"] = re.sub(r'http\S+', '', (ingredientStr.lower()))
    
    # step 0: transfer ingredient to lower case
    ingredientStr = re.sub(r'http\S+', '', (ingredientStr.lower()))
...
data['Ingredient list tagger'].head(30)[6]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Namibia.csv")
