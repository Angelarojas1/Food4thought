...
# #### Ingredient Tagger of Tajikistan
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Tajikistan.csv")
data.shape
...
data['List of ingredients_Eng'].head()[4]


# In[17]:


data['List of ingredients_Eng'].tail()
...
data['Ingredient list tagger'].head(10)[5]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Tajikistan.csv")
