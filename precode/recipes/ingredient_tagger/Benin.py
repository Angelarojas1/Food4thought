...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Benin.csv")
data.shape
...
data['List of ingredients_Eng'].tail(30)[29]
...
data['Ingredient list tagger'].head(30)[25]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Benin.csv")
