...
# #### Ingredient Tagger of Solomon Islands
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Solomon Islands.csv")
data.shape
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Solomon Islands.csv")
