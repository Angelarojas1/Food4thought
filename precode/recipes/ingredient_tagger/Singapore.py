...
# #### Ingredient Tagger of Singapore
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Singapore.csv")
data.shape
...
data['Ingredient list tagger'].head(30)[24]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Singapore.csv")
