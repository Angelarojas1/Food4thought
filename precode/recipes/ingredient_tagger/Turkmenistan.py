...
# #### Ingredient Tagger of Turkmenistan
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Turkmenistan.csv")
data.shape
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Turkmenistan.csv")
