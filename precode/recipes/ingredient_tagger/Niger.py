...
# #### Ingredient Tagger of Niger

# In[4]:


# import packages
get_ipython().system('pip install deep-translator==1.8.3')
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Niger.csv")
data.shape
...
data['List of ingredients_Eng'].tail()[3]
...
data['Ingredient list tagger'].tail()[2]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Niger.csv")
