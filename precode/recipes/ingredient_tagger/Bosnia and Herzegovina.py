...
# #### Ingredient Tagger of Bosnia and Herzegovina
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Bosnia and Herzegovina.csv")
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Bosnia and Herzegovina.csv")
