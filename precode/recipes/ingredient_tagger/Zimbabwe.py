...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Zimbabwe.csv")
data.shape
...
data['List of ingredients'].tail()[561]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Zimbabwe.csv")
