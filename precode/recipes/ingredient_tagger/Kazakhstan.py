...
# ```
# 
# #### Ingredient Tagger of Kazakhstan
# 
# 
# 
...
# import dataset
data1 = pd.read_csv("/content/drive/MyDrive/DATA/Kazakhstan.csv")
data2 = pd.read_csv("/content/drive/MyDrive/DATA/Kazakhstan.csv")
data3 = pd.read_csv("/content/drive/MyDrive/DATA/Kazakhstan.csv")
...
data1.dropna(subset=['List of ingredients'], inplace= True)
data2.dropna(subset=['List of ingredients'], inplace= True)
data3.dropna(subset=['List of ingredients'], inplace= True)
data1.shape
...
data1['List of ingredients'].head(400)[300]
...
data1['List of ingredients'] = data1['List of ingredients'].apply(lambda x: re.sub(r"[\[\]]",'',x))
data1['List of ingredients'] = data1['List of ingredients'].apply(lambda x: x.replace("'","").replace(':,',''))
data1['List of ingredients'] = data1['List of ingredients'].apply(lambda x: np.nan if '\\xa0,' in x or '\\xa0—\\xa0' in x else x)
data1.dropna(subset=['List of ingredients'], inplace= True)
data1.reset_index(drop=True,inplace=True)
data1['List of ingredients'] = data1['List of ingredients'].apply(lambda x: " ".join(x.split()))
data1['List of ingredients'] = data1['List of ingredients'].apply(lambda x: list(x.split(",")))
...
data2['List of ingredients'] = data2['List of ingredients'].apply(lambda x: re.sub(r"[\[\]]",'',x))
data2['List of ingredients'] = data2['List of ingredients'].apply(lambda x: x.replace("'","").replace(':,',''))
data2['List of ingredients'] = data2['List of ingredients'].apply(lambda x: np.nan if '\\xa0,' not in x or '\\xa0—\\xa0' in x else x)
data2.dropna(subset=['List of ingredients'], inplace= True)
data2.reset_index(drop=True,inplace=True)
data2['List of ingredients'] = data2['List of ingredients'].apply(lambda x: x.replace('\\xa0',' -'))
data2['List of ingredients'] = data2['List of ingredients'].apply(lambda x: " ".join(x.split()))
data2['List of ingredients'] = data2['List of ingredients'].apply(lambda x: list(re.findall("\,".join(["[^,)]+"] * 3), x)))
...
data3['List of ingredients'] = data3['List of ingredients'].apply(lambda x: re.sub(r"[\[\]]",'',x))
data3['List of ingredients'] = data3['List of ingredients'].apply(lambda x: np.nan if  '\\xa0—\\xa0' not in x else x)
data3.dropna(subset=['List of ingredients'], inplace= True)
data3.reset_index(drop=True,inplace=True)
data3['List of ingredients'] = data3['List of ingredients'].apply(lambda x: x.replace("'","").replace('\\xa0',' -').replace('—',''))
data3['List of ingredients'] = data3['List of ingredients'].apply(lambda x: " ".join(x.split()))
data3['List of ingredients'] = data3['List of ingredients'].apply(lambda x: x.replace(":,",""))
data3['List of ingredients'] = data3['List of ingredients'].apply(lambda x: list(x.split(",")))
...
data2['List of ingredients'].head(100)[11]
...
data1['List of ingredients_Eng'] = data1['List of ingredients'].apply(lambda x:transIngredient(x))
data2['List of ingredients_Eng'] = data2['List of ingredients'].apply(lambda x:transIngredient(x))
data3['List of ingredients_Eng'] = data3['List of ingredients'].apply(lambda x:transIngredient(x))
...
data['List of ingredients_Eng'].head()


# In[24]:


data['List of ingredients_Eng'].head(300)[200]
...
def ingredientTagger(ingredientLst):
    ...
    ingredientLst = (ingredientLst.lower()).replace('-, -,','-').replace(',','').replace('- -','- ')
    result["input"] = ingredientLst
    
    if "-" in ingredientLst: 
      result['item'] = ingredientLst.split('-', 1)[0]
      ingredientStr = ingredientLst.split('-',1)[1] 
      ...
      if num_there(ingredientStr) == False:
          ...
          if ifUnit(ingredientStr)[0] == True:
              ...
              if ingredientStr.split()[ifUnit(ingredientStr)[1]-1] == "a" and ingredientStr.split()[ifUnit(ingredientStr)[1]-2] == "half":
                  ...
                  result["preparation"] = ' '.join(ingredientStr.split()[ifUnit(ingredientStr)[1]+1:]) 
      ...
      # step 4: if a digit is in the ingredient 
          ...
          if "of" in ingredientStr.split():
              ...
              if num_there(ingredientStr.split("of")[0]):
                  result["preparation"] = ingredientStr.split("of")[1]
                  ...
                  if ifUnit(ingredientStr)[0] == True:
                      ...
                      result["qty"] = re.findall(r"[-+]?(?:\d*\.\d+|\d+)", ingredientStr)[0]
                      result["preparation"] = re.sub(r"[-+]?(?:\d*\.\d+|\d+)", '', ingredientStr)
...
data['Ingredient list tagger'].head(300)[289]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Kazakhstan.csv")
