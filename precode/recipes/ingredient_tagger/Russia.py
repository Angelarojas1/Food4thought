...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Russia.csv")
data.shape
...
data['List of ingredients_Eng'].head(100)[49]
...
data['Ingredient list tagger'].head(40)[15]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Russia.csv")
