...
# #### Ingredient Tagger of South Korea
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/South Korea.csv")
data.shape
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/South Korea.csv")
