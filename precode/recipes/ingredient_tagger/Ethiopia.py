...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Ethiopia.csv")
data.shape
...
data['List of ingredients'] = data['List of ingredients'].apply(lambda x: x.strip())
data['List of ingredients'] = data['List of ingredients'].apply(lambda x: x.replace( '&', 'and'))
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Ethiopia.csv")
