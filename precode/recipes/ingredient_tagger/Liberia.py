...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Liberia.csv")
data.shape
...
data['Ingredient list tagger'].head(20)[19]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Liberia.csv")
