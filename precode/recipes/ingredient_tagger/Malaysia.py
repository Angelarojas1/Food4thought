...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Malaysia.csv")
data.shape
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Malaysia_Eng.csv")


# In[11]:


data['List of ingredients_Eng'].tail(200)[350]
...
data['Ingredient list tagger'].head(3000)[465]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Malaysia.csv")
