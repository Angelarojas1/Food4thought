...
# #### Ingredient Tagger of Liechtenstein
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/raw/Liechtenstein.csv")
data.head()
...
data['List of ingredients'] = data['List of ingredients'].apply(lambda x: [i for i in x if i])
...
data['Ingredient list tagger'].head(20)[1]
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Liechtenstein.csv")
