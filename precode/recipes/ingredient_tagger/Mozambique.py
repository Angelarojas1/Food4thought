...
# #### Ingredient Tagger of Mozambique
...
# import dataset
data = pd.read_csv("/content/drive/MyDrive/DATA/Mozambique.csv")
data.shape
...
data['List of ingredients'].head(10)[6]
...
data['List of ingredients'].tail()[7]
...
data['Ingredient list tagger'].tail(30)[5]
...
data.to_csv("/content/drive/MyDrive/DATA/INTERMEDIATE/Mozambique.csv")
