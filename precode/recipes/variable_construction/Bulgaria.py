...
# #### Variable constructions of Bulgaria
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Bulgaria.csv")
data.head()
...
# correct data
data.loc[559,"Ingredient list tagger"][1]['qty'] = 1.5
data.loc[1294,"Ingredient list tagger"][-2]['qty'] = 0.5
data.loc[1794,"Ingredient list tagger"][2]['qty'] = 0.5
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Bulgaria.csv")
