...
# #### Variable constructions of Estonia
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Estonia.csv")
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Estonia.csv")
