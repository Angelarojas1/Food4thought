...
# #### Variable constructions of India
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/India.csv")
...
data = data[data['recipeCategory'] != 'World Breakfast']
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/India.csv")
