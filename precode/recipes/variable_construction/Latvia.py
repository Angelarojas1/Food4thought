...
# ####  Variable constructions of Latvia
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Latvia.csv")
...
def verbList(instructionLst):
    ...
    for instruction in instructionLst:
        ...
        for word in ["minūtes","stundas","dienas"]:
            if word in instruction:
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Latvia.csv")
