...
# ### Variable constructions for Kazakhstan
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Kazakhstan.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Kazakhstan.csv")
