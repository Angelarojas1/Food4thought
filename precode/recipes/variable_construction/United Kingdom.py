...
# ### Variable constructions for United Kingdom
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/United Kingdom.csv")
...
def getTime(string):
    ...
    return float(digits[1])*60+float(digits[2])
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/United Kingdom.csv")
