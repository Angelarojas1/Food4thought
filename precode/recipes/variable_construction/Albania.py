...
# #### Variable constructions of Albania
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Albania.csv")
...
inactiveList = ['bake',  'simmer','take','cool', 'stand', 'add', 'boil', 'bring', 'leave', 'let', 'soak', 
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Albania.csv")
