...
# ### Variable constructions for Croatia
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Croatia.csv")
...
data['Total time'] = data['Prep time'].str.extract('(\d+)')
...
for i in range(len(data)):
    try:
        calNumSpices(data.loc[i,'Core ingredient'])
    except:
        print(i)
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Croatia.csv")
