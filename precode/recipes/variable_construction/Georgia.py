...
# #### Variable constructions of Georgia
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Georgia.csv")
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Georgia.csv")
