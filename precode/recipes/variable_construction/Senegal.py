...
# ####  Variable constructions of Senegal
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Senegal.csv")
...
def verbList(instructionLst):
    ...
    for instruction in instructionLst:
        ...
        for word in ["minutes","minute","ora","ore"]:
            if word in instruction:
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Senegal.csv")
