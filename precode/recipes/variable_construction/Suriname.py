...
# ### Variable constructions for Suriname
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Suriname.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Suriname.csv")
