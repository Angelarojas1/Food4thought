...
# ### Variable constructions for Kuwait
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Kuwait.csv")
    ...
    if isinstance(string, str):
        ...
        if len(digits) == 1:
            ...
            if "/" not in string:
                ...
                return float(digits[0])/float(digits[1])*60
        
        elif len(digits) == 3:
            return (float(digits[0]) + float(digits[1])/float(digits[2]))*60
    else:
        return string
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Kuwait.csv")
