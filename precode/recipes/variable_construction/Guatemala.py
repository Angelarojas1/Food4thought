...
# #### Variable constructions of Guatemala
...
print(set(data['Total time']))

data['Total time'].replace({'+2 horas': 180,'1 hora': 60, '15 minutos': 15, '2 horas': 120, '30 minutos': 30},inplace=True)
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Guatemala.csv")
