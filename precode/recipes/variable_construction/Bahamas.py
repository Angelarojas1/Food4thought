...
# #### Variable constructions of Bahamas
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Bahamas.csv")
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Bahamas.csv")
