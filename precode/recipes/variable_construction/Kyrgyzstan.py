...
# ### Variable constructions for Kyrgyzstan
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Kyrgyzstan.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Kyrgyzstan.csv")
