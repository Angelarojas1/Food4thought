...
# ### Variable constructions for Dominica
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Dominica.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Dominica.csv")
