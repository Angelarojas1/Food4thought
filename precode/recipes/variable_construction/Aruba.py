...
# #### Variable constructions of Aruba
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Aruba.csv")
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Aruba.csv")
