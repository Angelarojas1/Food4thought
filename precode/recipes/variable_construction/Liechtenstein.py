...
# ### Variable constructions for Liechtenstein
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Liechtenstein.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Liechtenstein.csv")
