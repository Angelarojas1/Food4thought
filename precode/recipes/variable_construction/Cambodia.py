...
# #### Variable constructions of Cambodia
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Cambodia.csv")
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Cambodia.csv")
