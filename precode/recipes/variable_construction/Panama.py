...
# ####  Variable constructions of Panama
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Panama.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Panama.csv")
