...
# ####  Variable constructions of Spain
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Spain.csv")
...
def verbList(instruction):
    ...
    for instruction in instructionLst:
        ...
        for word in ["minutos","horas","minuto","hora"]:
            if word in instruction:
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Spain.csv")
