...
# ####  Variable constructions of Hungary
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Hungary.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Hungary.csv")
