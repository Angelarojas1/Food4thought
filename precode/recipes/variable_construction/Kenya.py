...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Kenya.csv")
data.head()
...
data['Total time'] = data['Prep time'] + data['Cooking time']
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Kenya.csv")
