...
# ### Variable constructions for Ukraine
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Ukraine.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Ukraine.csv")
