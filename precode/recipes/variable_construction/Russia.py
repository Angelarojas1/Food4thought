...
# ####  Variable constructions of Russia
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Russia.csv")
...
def getTime(timeString):
    """
    timeString: string of time
    output: time in minutes
    
    """
    
    timeLst = [int(s) for s in re.findall(r'\d+',timeString)]
    
    return timeLst[0]*24*60+timeLst[1]*60+timeLst[2]
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Russia.csv")
