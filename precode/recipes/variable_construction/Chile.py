...
# #### Variable constructions of Chile
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Chile.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Chile.csv")
