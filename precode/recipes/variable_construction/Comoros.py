...
# ####  Variable constructions of Comoros
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Comoros.csv")
...
def verbList(instruction):
    ...
    for instruction in instructionLst:
        ...
        for word in ["minute","minutes","min","heures",'heure']:
            if word in instruction:
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Comoros.csv")
