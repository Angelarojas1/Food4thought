...
# ### Variable constructions for Cote d'Ivoire
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Cote Divoire.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Cote d'Ivoire.csv")
