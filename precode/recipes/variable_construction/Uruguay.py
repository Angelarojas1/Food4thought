...
# ####  Variable constructions of Uruguay
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Uruguay.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Uruguay.csv")
