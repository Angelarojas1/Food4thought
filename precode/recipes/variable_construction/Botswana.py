...
# #### Variable constructions of Botswana
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Botswana.csv")
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Botswana.csv")
