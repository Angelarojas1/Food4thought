...
# #### Variable constructions of Jordan
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Jordan.csv")
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Jordan.csv")
