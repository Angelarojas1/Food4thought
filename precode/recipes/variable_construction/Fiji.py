...
# #### Variable constructions of Fiji
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Fiji.csv")
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Fiji.csv")
