...
# #### Variable constructions of Belize
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Belize.csv")
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Belize.csv")
