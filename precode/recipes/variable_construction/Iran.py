...
# #### Variable constructions of Iran
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Iran.csv")
...
def getTime(string):
    ...
    if len(stringLst) == 1:
        ...
        return stringLst[0]*60+stringLst[1]
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Iran.csv")
