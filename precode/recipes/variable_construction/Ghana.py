...
# ####  Variable constructions of Ghana
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Ghana.csv")
...
data['List of instructions'][0].split('\n')
...
def verbList(instruction):
    ...
    if instruction != instruction:
        return []
    instructionLst = instruction.split('\n')
    ...
    for instruction in instructionLst:
        ...
        for word in ["minute","minutes","hour","hours",'day','days','min']:
            if word in instruction:
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Ghana.csv")
