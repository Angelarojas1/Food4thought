...
# ### Variable constructions for Lao
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Laos.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Laos.csv")
