...
# ####  Variable constructions of Haiti
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Haiti.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Haiti.csv")
