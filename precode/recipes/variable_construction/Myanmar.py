...
# ####  Variable constructions of Myanmar
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Myanmar.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Myanmar.csv")
