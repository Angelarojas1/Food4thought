...
# #### Variable constructions of Egypt
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Egypt.csv")
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Egypt.csv")
