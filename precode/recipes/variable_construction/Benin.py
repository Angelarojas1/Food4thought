...
# ####  Variable constructions of Benin
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Benin.csv")
...
def verbList(instructionLst):
    ...
    for instruction in instructionLst:
        ...
        for word in ["min","heure","heures",'minute','minutes']:
            if word in instruction:
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Benin.csv")
