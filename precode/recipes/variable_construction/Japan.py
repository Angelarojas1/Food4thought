...
# #### Variable constructions of  Japan
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Japan.csv")
...
# transfer from seconds to minutes
data['Total time'] = data['Total time'].apply(lambda x: x/60)
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Japan.csv")
