...
# #### Variable constructions of Guyana
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Guyana.csv")
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Guyana.csv")
