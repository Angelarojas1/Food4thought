...
# #### Variable constructions of Algeria
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Algeria.csv")
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Algeria.csv")
