...
# ### Variable constructions for Syria
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/intermediate/Syria.csv")
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Syria.csv")
