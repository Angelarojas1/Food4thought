...
# ####  Variable constructions of Côte d'Ivoire
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Cabo Verde.csv")
...
def verbList(instructionLst):
    ...
    timeInstruction = []
    instructionLst = [i['text'] for i in instructionLst]
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Cabo Verde.csv")
