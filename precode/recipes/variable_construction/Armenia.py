...
# #### Variable constructions of Armenia
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Armenia.csv")
data.head()
...
data['List of ingredients'] = data['List of ingredients'].apply(lambda x:ast.literal_eval(x[0]))
...
data['Number of ingredients'] = data['List of ingredients'].apply(lambda x: len(x))
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Armenia.csv")
