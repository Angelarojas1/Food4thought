...
# #### Variable constructions of Jamaica
...
# import dataset
data = pd.read_csv("/Users/xixi/Dropbox/food4thought/data/final/Jamaica.csv")
data.head()
...
data.to_csv("/Users/xixi/Dropbox/food4thought/data/final/Jamaica.csv")
