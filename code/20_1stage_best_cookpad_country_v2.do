...
*		estadd scalar mean = `mean'
	...
	outreg2 using "${outputs}/Tables/iv_best/cookpad/`var'_country_v2.xls", lab dec(4) excel par(se) stats(coef se) keep(std_native std_import) addstat(f-value, `fval') ctitle("`x'`y'_`z'") nocons title("`var'")
	...
	erase "${outputs}/Tables/iv_best/cookpad/ltime_country_v2.txt"
	erase "${outputs}/Tables/iv_best/cookpad/ing_country_v2.txt"
	erase "${outputs}/Tables/iv_best/cookpad/spice_country_v2.txt"