...
*		estadd scalar mean = `mean'
	...
	outreg2 using "${outputs}/Tables/iv_best/cookpad/best_`var'.xls", lab dec(4) excel par(se) stats(coef se) keep(fem_nat fem_imp) addstat(f-value, `fval') ctitle("`x'`y'_`z'") nocons title("`var'")
	...
	erase "${outputs}/Tables/iv_best/cookpad/best_ltime.txt"
	erase "${outputs}/Tables/iv_best/cookpad/best_ing.txt"
	erase "${outputs}/Tables/iv_best/cookpad/best_spice.txt"