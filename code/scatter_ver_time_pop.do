...
// 	restore
	...
	* Create variables as we use them in the regressions
	...
	twoway (scatter logtime_median std_import [w=pop]) ///
	(scatter logtime_median std_import, msy(none) mlab(country) leg(off) mlabsize(vsmall) mlabcolor(black)) , /// Outlier is cyprus
	xtitle("Imported Versatility `z'", size(small)) ytitle("log time median", size(small)) ///
	xlabel(, nogrid) ylabel(,nogrid) 
	
	graph export "${outputs}/data_check/scatter/pop19_`z'.png", replace
...
restore	
	...
	putpdf begin
	putpdf paragraph
	putpdf image ${outputs}/data_check/scatter/pop19_p0.png
	putpdf image ${outputs}/data_check/scatter/pop19_p10.png
	putpdf image ${outputs}/data_check/scatter/pop19_p25.png
	putpdf image ${outputs}/data_check/scatter/pop19_p33.png
	putpdf image ${outputs}/data_check/scatter/pop19_p50.png
	putpdf image ${outputs}/data_check/scatter/pop19_p60.png
	putpdf image ${outputs}/data_check/scatter/pop19_p66.png
	putpdf image ${outputs}/data_check/scatter/pop19_p70.png
	putpdf save ${outputs}/data_check/scatter/scatter_imp.pdf, replace
...
//	
// 	graph export "${outputs}/data_check/scatter/pop2019.pdf", replace
...
//	
// 	graph export "${outputs}/data_check/scatter/pop2023.pdf", replace
