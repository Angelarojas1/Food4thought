...
* import GDP dataset
import delimited "${rawdata}/gdp/GDP.csv", encoding(UTF-8) varnames(1) case(lower) clear
...
** save dataset
save "${gdp}/GDPlong2019.dta", replace
note

*------------------- GDP Per Capita ---------------*
* import GDP dataset
import delimited "${rawdata}/gdp/GDP_pc.csv", encoding(UTF-8) varnames(1) case(lower) clear
...
** save dataset
save "${gdp}/GDPlong2019_pc.dta", replace
note
