...
quietly merge 1:1 adm0 using "${versatility}/imported/importbycountry_v3_`z'.dta"
*assert _merge !=2
...
*		estadd scalar mean = `mean'
	...
	outreg2 using "${outputs}/Tables/iv_best/cookpad/$today/`var'_country_v3.xls", lab dec(4) excel par(se) stats(coef se) keep(std_import) addstat(f-value, `fval') ctitle("`z'") nocons title("`var'")
