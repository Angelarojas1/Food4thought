...
*		estadd scalar mean = `mean'
	...
	outreg2 using "${outputs}/Tables/iv_best/cookpad/`var'_v1_nn.xls", lab dec(4) excel par(se) stats(coef se) keep(fem_imp) addstat(f-value, `fval') ctitle("`z'") nocons title("`var'")
	...
	erase "${outputs}/Tables/iv_best/cookpad/ltime_v1_nn.txt"
	erase "${outputs}/Tables/iv_best/cookpad/ing_v1_nn.txt"
	erase "${outputs}/Tables/iv_best/cookpad/spice_v1_nn.txt"