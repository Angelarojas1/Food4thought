...
* imported data
import delimited "${versatility}/imported/imported_v4.csv", clear 
...
save "${versatility}/imported/importbycountry_v4_`x'.dta", replace
restore
...
foreach l of local level{
	...
	* append to original data 
	append using "${versatility}/imported/importbycountry_v4_`x'.dta" 
	save "${versatility}/imported/importbycountry_v4_`x'.dta", replace
}
